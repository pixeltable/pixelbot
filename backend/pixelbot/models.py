...
# ── Agent Workflow (pixelbot_v3.tools) ────────────────────────────────────────────


class ToolAgentRow(BaseModel):
    """Row model for the pixelbot_v3.tools table."""
...
# ── Chat History (pixelbot_v3.chat_history) ───────────────────────────────────────


class ChatHistoryRow(BaseModel):
    """Row model for the pixelbot_v3.chat_history table."""
...
# ── Memory Bank (pixelbot_v3.memory_bank) ─────────────────────────────────────────


class MemoryBankRow(BaseModel):
    """Row model for the pixelbot_v3.memory_bank table."""
...
# ── User Personas (pixelbot_v3.user_personas) ─────────────────────────────────────


class UserPersonaRow(BaseModel):
    """Row model for the pixelbot_v3.user_personas table."""
...
# ── Image Generation (pixelbot_v3.image_generation_tasks) ─────────────────────────


class ImageGenRow(BaseModel):
    """Row model for the pixelbot_v3.image_generation_tasks table."""
...
class FluxGenRow(BaseModel):
    """Row model for the pixelbot_v3.flux_generation_tasks table."""
...
class VideoGenRow(BaseModel):
    """Row model for the pixelbot_v3.video_generation_tasks table."""
...
# ── Media Tables (pixelbot_v3.collection / images / videos / audios) ──────────────


class DocumentRow(BaseModel):
    """Row model for the pixelbot_v3.collection table."""
...
class ImageRow(BaseModel):
    """Row model for the pixelbot_v3.images table."""
...
class VideoRow(BaseModel):
    """Row model for the pixelbot_v3.videos table."""
...
class AudioRow(BaseModel):
    """Row model for the pixelbot_v3.audios table."""
...
MEDIA_ROW_MODELS: dict[str, type[BaseModel]] = {
...
# ── CSV Registry (pixelbot_v3.csv_registry) ───────────────────────────────────────


class CsvRegistryRow(BaseModel):
    """Row model for the pixelbot_v3.csv_registry table."""
...
# ── Speech Generation (pixelbot_v3.speech_tasks) ──────────────────────────────────


class SpeechTaskRow(BaseModel):
    """Row model for the pixelbot_v3.speech_tasks table."""
...
# ── Prompt Experiments (pixelbot_v3.prompt_experiments) ───────────────────────────


class PromptExperimentRow(BaseModel):
    """Row model for the pixelbot_v3.prompt_experiments table."""
...
class NotificationRow(BaseModel):
    """Row model for the pixelbot_v3.notifications table."""
