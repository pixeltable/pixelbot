...
|---|---|---|
| `AppLayout` | `app-layout.tsx` | Sidebar nav (collapsible, 200px/56px) with **grouped navigation** (Conversation: Chat/History/Memory, Workspace: Media Library/Studio/Prompt Lab, System: Database/Developer/Architecture) separated by thin dividers and uppercase group labels. Settings at bottom. No top bar — clean full-height content area. Footer links to Pixeltable GitHub with SVG icon. |
